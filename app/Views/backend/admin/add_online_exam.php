<div class="col-sm-12">
    <div class="panel panel-info">
        <div class="panel-body table-responsive">
            ...
            <hr>
            <?= form_open(base_url('admin/manage_online_exam/create'), ['class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <select name="class_id" id="class_id" class="form-control selectboxit" onchange="get_class_section_subject(this.value)" required>
